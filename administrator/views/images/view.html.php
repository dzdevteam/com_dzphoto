 ...
 */
class DzphotoViewImages extends JViewLegacy
{
    protected $items;
    ...
    public function display($tpl = null)
    {
        ...
        DzphotoHelper::addSubmenu('images');
    ...
    protected function addToolbar()
    {
        ...
        $canDo  = DzphotoHelper::getActions($state->get('filter.category_id'));
        ...
        JHtmlSidebar::setAction('index.php?option=com_dzphoto&view=images');
