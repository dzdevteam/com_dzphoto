...
JText::script("COM_DZPHOTO_ALBUMS_ADD_IMAGES");
            ...
            <thead>
                <tr>
                    ...
                    <th width="15%" class="center">
                        <?php echo JText::_('COM_DZPHOTO_ALBUMS_HEADING_IMAGES'); ?>
                    </th>
                    ...
                    <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->parent_id; ?>" item-id="<?php echo $item->id ?>" parents="<?php echo $parentsStr ?>" level="<?php echo $item->level ?>">
                        ...
                        <td class="center">
                            <a 
                                ...
                                data-title="<?php echo JText::_('COM_DZPHOTO_ALBUMS_VIEW_IMAGES_DESC') ?>"
                            ...
                            <a 
                                class="btn btn-link album-modal hasTooltip" href="#" 
                                data-title="<?php echo JText::_('COM_DZPHOTO_ALBUMS_ADD_IMAGES_DESC') ?>"
                                data-album-title="<?php echo $this->escape($item->title); ?>" 
                                data-album-id="<?php echo (int) $item->id; ?>"
                                data-album-mode="add">
...
<div id="item-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-body">
        <iframe src="" class="auto-height" style="border: none; width: 100%; overflow-y: hidden;" width="100%" scrolling="no"></iframe>
        <script>
        jQuery('iframe.auto-height').iframeAutoHeight({minHeight: 240});
        </script>
    </div>
